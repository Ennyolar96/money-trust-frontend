...
export default function OTPVerificationCorporate() {
            ...
            <div>
              ...
              >
                <Form className="space-y-4">
                  <div>
                    <InputForm
                      label={`Enter the 4 digit code that was sent to ${data.email} `}
                      name="code"
                      type="text"
                      maxLength={4}
                    ...
                    <button
                      ...
                      className="text-xs text-[#98A9BCCC]"
                    >
                      Resend Code
                    </button>{" "}
                    <br />
                  ...
                  <div className="flex justify-between">
                    <div>
                      <Link
                        to="/register/corporate/login-details"
